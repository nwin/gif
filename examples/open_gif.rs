...
fn main() {
    ...
    let mut decoder = gif::Reader::new(File::open("tests/samples/sample_big.gif").unwrap());
    decoder.set(gif::ColorOutput::TrueColor);
    let frames = decoder.read_to_end().unwrap();
    
    let mut crc = Crc32::new();
    crc.update(&*frames[0].buffer);
    
    image::save_buffer(
        "sample_1.gif.png",
        &*frames[0].buffer,
        frames[0].width as u32,
        frames[0].height as u32,
